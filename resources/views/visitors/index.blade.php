    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item cta"><a href="practice-single.html" class="nav-link">Member Login</a></li>
            </ul>
        </div>
    </div>
</nav>
    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start"
            ...
            <div class="col-md-6 ftco-animate">
                ...
                <h1>We Provide Highest Quality
                    <span class="txt-rotate" data-period="2000"
                          data-rotate='[ "Investments.", "Networks.", "Services.", "Returns." ]'></span>
                </h1>
    ...
    <div class="container">
        ...
        <div class="row d-flex">
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry justify-content-end">
                    <div class="text px-4 py-4">
                        <h3 class="heading mb-0"><a href="#">South Africa Investor Mission</a></h3>
                    </div>
                    ...
                    <div class="text p-4 float-right d-block">
                        ...
                        <p>The event stated above will take place in the date shown and will be for investors.
                            e.t.c.</p>
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry justify-content-end">
                    <div class="text px-4 py-4">
                        <h3 class="heading mb-0"><a href="#">Dubai Investor Mission</a></h3>
                    </div>
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry justify-content-end">
                    <div class="text px-4 py-4">
                        <h3 class="heading mb-0"><a href="#">Rift Valley Investor Mission</a></h3>
                    </div>
